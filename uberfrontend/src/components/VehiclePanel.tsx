...
interface VehiclePanelProps {
    selectVehicle: (vehicle: "CAR" | "BIKE" | "AUTO" | undefined) => void;
    fare: Record<vechileTypeProps, number>
    setConfirmRidePanel: (value: boolean) => void;
    setVehiclePanel: (value: boolean) => void;
}


const VehiclePanel = ({ fare, selectVehicle, setConfirmRidePanel, setVehiclePanel }: VehiclePanelProps) => {
    return (
        <div>
